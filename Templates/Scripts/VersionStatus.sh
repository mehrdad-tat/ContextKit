#!/bin/bash
# Template Version: 8 | ContextKit: 0.2.5 | Updated: 2025-09-24
...
update_global_contextkit() {
    ...
    if [ ! -d "$CONTEXTKIT_DIR" ]; then
        ...
        echo "     💡 Install: curl -fsSL https://raw.githubusercontent.com/mehrdad-tat/ContextKit/main/install.sh | sh"
        return 1
    fi
